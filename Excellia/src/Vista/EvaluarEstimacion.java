 ...
 * @author Ronaldo
 */
public class EvaluarEstimacion extends javax.swing.JDialog {
    ...
    String id;
    KAMBL k = new KAMBL();
    public EvaluarEstimacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        this.setTitle("Evaluar Estimación");
    }
    
    public EvaluarEstimacion(java.awt.Frame parent, boolean modal,String x,String id) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        this.setTitle("Evaluar Estimación");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Evaluar Estimación");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton1.isSelected())k.aprobarEstimacion(id);
        if(jRadioButton2.isSelected())k.desaprobarEstimacion(id);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvaluarEstimacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EvaluarEstimacion dialog = new EvaluarEstimacion(new javax.swing.JFrame(), true);
